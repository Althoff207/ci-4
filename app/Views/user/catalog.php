    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      ...
      <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link  active" href="/user/catalog">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex px-2 py-1">
                                <div>
                                  <img src="<?= base_url('uploads/' . $b['gambar']) ?>" class="avatar avatar-sm me-3" alt="Gambar Berita">
                                </div>
                              </div>
                            </td>
                            <td>
                              <h6 class="mb-0 text-sm"><?= esc($b['judul']) ?></h6>
                            </td>
                            <td>
                              <p class="text-xs text-secondary mb-0"><?= esc($b['deskripsi']) ?></p>
                            </td>
                            <td class="align-middle text-center">
                              <span class="text-secondary text-xs font-weight-bold"><?= esc($b['penulis']) ?></span>
                            </td>
                            <td class="align-middle text-center">
                              <span class="text-secondary text-xs font-weight-bold"><?= esc($b['jadwal']) ?></span>
                            </td>
                          </tr>
                        <?php endforeach; ?>
                      <?php endif; ?>
